...
| ID | Preconditions | Scenario | Steps | Expected Result | Status | Automation |
|----|--------------|---------|------|----------------|-------|-----------|
| TC-TRANS-001 | User is registered and logged into the system. User has sufficient balance available. | Transfer money successfully | 1. Click **"$ NEW"** <br> 2. Select a contact <br> 3. Enter a valid transfer amount <br> 4. Add a transfer note <br> 5. Click **"Pay"** | - Success confirmation message is displayed <br> - User balance is updated correctly <br> - Transaction appears in the transaction history | Pass | Yes |
| TC-TRANS-002 | User is registered and logged into the system. | Do not allow transfer with negative value | 1. Click **"$ NEW"** <br> 2. Select a contact <br> 3. Enter a negative transfer amount (example: -5) <br> 4. Add a transfer note <br> 5. Click **"Pay"** | - System should block the transaction <br> - Error message should be displayed <br> - Balance must not increase or change | Failed | Yes |
| TC-TRANS-003 | User is registered and logged into the system. User has sufficient balance available. | Allow transfer with decimal values (cents) | 1. Click **"$ NEW"** <br> 2. Select a contact <br> 3. Enter a transfer amount with cents (example: 1.50) <br> 4. Add a transfer note <br> 5. Click **"Pay"** | - The system should process the transfer including the cents value <br> - Balance should be updated with the exact transferred amount <br> - Transaction should appear correctly in the history | Failed | Yes |
